...
data <- read.csv("activity.csv", header=TRUE, colClasses=c("numeric", "Date", "factor"), stringsAsFactors=FALSE)
str(data)
summary(data)
```
...
tData <- rbind(weekend_spi, weekday_spi)
tData$dayofweek <- as.factor(tData$dayofweek)
